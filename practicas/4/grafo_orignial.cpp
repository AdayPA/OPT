  ...
  do{
    ...
    for (unsigned i = 0; i < n; i++) {
      if (i != s){
        ...
        } else cout << "ERROR. No hay camino desde: " << s + 1 <<" al nodo " << i + 1 <<endl;
      }    
    }
 }
...
//Apto: pedir un destino y en la imprimir solo ese camino
//Apto+: en bellman decir cual es el ciclo(pista: si miramos pred se cicla)
